  ...
  <div class="col">
    <div class="card shadow-sm">
      <div class="card-body">
        ...
        Número de partidos jugados: <span class="total_combats"></span><br />
        WINS: <span class="total_victoires"></span><br />
        Pérdidas: <span class="total_defaites"></span><br />
        Proporción total de muertes: <span class="total_killratio"></span><br />
        <br />
      </div>
    </div>
  </div>
...
const data_all_elos_Chart = {
  ...
  datasets: [{
    label: 'ELOs por aeronave utilizada',
...
for (j = 0; j < labels_all_elos_Chart.length; j++) {
  data_elos_Chart[labels_all_elos_Chart[j]] = {
    ...
    {
      type: 'bar',
      label: labels_all_elos_Chart[j] + ' Clasificación',
  ...
  $(ref_class).replaceWith('<div class="col">'+
    ...
    '<div class="col">'+
      '<div class="card shadow-sm">'+
        '<div class="card-body">'+
          '<h3><span class="icon-'+ac_icons.get(labels_all_elos_Chart[j])+'-h"></span> '+ labels_all_elos_Chart[j] +' Estadísticas</h3>'+
          'Último rango: #'+ derniers_classements[labels_all_elos_Chart[j]] +'<br />'+
          'Número de partidos jugados: '+ data_elos[labels_all_elos_Chart[j]].length +'<br />'+
          'WINS: '+ victoires[labels_all_elos_Chart[j]] +'<br />'+
          'Pérdidas: '+ defaites[labels_all_elos_Chart[j]] +'<br />'+
          'Proporción de muertes: '+ killsratio[labels_all_elos_Chart[j]] +'<br />'+
          '<br />'+
        '</div>'+
      '</div>'+
    '</div>'+
